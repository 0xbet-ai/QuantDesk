...
/**
 * Derive all 4 standard metrics from a trade list. Single source of
 * truth for metric calculation — every engine adapter calls this
 * instead of computing metrics itself. Guarantees consistency across
 * Freqtrade, Nautilus, and Generic backtests.
 *
